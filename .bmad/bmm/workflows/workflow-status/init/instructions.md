...
<ask>Your choice [a/b]:</ask>
  ...
  <check if="choice == b">
    <output>
     **Warning:** BMM workflows are optimized for software development, not game development.
 ...
 **Trade-off:** Less upfront planning = higher risk of rework if complexity emerges
