...
- `1.3-E2E-001`  - 145 seconds (exceeds 90s target) - Optimize fixture setup
- `1.3-UNIT-005`  - 320 lines (exceeds 300 line limit) - Split into multiple test files
...
- **Deterministic Rules:** Use consistent thresholds (P0=100%, P190%, overall80%) for objectivity
