...
| Criterion              | Threshold                 | Actual               | Status   |
| ---------------------- | ------------------------- | -------------------- | -------- | ----------- | -------- |
| P1 Coverage            | {min_p1_coverage}%       | {p1_coverage}%       | { PASS |  CONCERNS |  FAIL} |
| P1 Test Pass Rate      | {min_p1_pass_rate}%      | {p1_pass_rate}%      | { PASS |  CONCERNS |  FAIL} |
| Overall Test Pass Rate | {min_overall_pass_rate}% | {overall_pass_rate}% | { PASS |  CONCERNS |  FAIL} |
| Overall Coverage       | {min_coverage}%          | {overall_coverage}%  | { PASS |  CONCERNS |  FAIL} |

**P1 Evaluation**: { ALL PASS |  SOME CONCERNS |  FAILED}
