...
| ------------------------------------ | ------------------------------- | ---------- | ------------ |
| BDD Format (Given-When-Then)         | { PASS \|  WARN \|  FAIL} | {count}    | {brief_note} |
| Test IDs                             | { PASS \|  WARN \|  FAIL} | {count}    | {brief_note} |
| Priority Markers (P0/P1/P2/P3)       | { PASS \|  WARN \|  FAIL} | {count}    | {brief_note} |
| Hard Waits (sleep, waitForTimeout)   | { PASS \|  WARN \|  FAIL} | {count}    | {brief_note} |
| Determinism (no conditionals)        | { PASS \|  WARN \|  FAIL} | {count}    | {brief_note} |
| Isolation (cleanup, no shared state) | { PASS \|  WARN \|  FAIL} | {count}    | {brief_note} |
| Fixture Patterns                     | { PASS \|  WARN \|  FAIL} | {count}    | {brief_note} |
| Data Factories                       | { PASS \|  WARN \|  FAIL} | {count}    | {brief_note} |
| Network-First Pattern                | { PASS \|  WARN \|  FAIL} | {count}    | {brief_note} |
| Explicit Assertions                  | { PASS \|  WARN \|  FAIL} | {count}    | {brief_note} |
| Test Length (300 lines)             | { PASS \|  WARN \|  FAIL} | {lines}    | {brief_note} |
| Test Duration (1.5 min)             | { PASS \|  WARN \|  FAIL} | {duration} | {brief_note} |
| Flakiness Patterns                   | { PASS \|  WARN \|  FAIL} | {count}    | {brief_note} |
