...
-  **WARN**: Tests have some structure but not explicit GWT
...
-  **WARN**: Some test IDs missing or inconsistent
...
-  **WARN**: Some priority classifications missing
...
-  **WARN**: Some hard waits used but with justification comments
...
-  **WARN**: Some conditionals but with clear justification
...
-  **WARN**: Some cleanup missing but isolated enough
...
-  **WARN**: Some fixtures used but not consistently
...
-  **WARN**: Some factories used but also hardcoded data
...
-  **WARN**: Some routes intercepted correctly, others after navigation
...
-  **WARN**: Some tests rely on implicit waits instead of assertions
...
-  **WARN**: Test file 301-500 lines (consider splitting)
...
-  **WARN**: Some potential flaky patterns (e.g., tight timeouts, race conditions)
