...
Will update existing story file rather than creating new one.
  ...
  <step n="8" goal="Validate, save, and mark story drafted" tag="sprint-status">
    ...
    <check if="story key not found in file">
      <output> Could not update story status: {{story_key}} not found in sprint-status.yaml
...
** Important:** The following workflows are context-intensive. It's recommended to clear context and restart the SM agent before running the next command.
