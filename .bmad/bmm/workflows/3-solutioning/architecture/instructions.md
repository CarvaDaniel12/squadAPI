...
<check if="status file found">
  ...
  <check if="create-architecture status is indicates already completed">
    <output> Architecture already completed: {{create-architecture status}}</output>
  ...
  <check if="create-architecture is not the next expected workflow">
    <output> Next expected workflow: {{next_workflow}}. Architecture is out of sequence.</output>
