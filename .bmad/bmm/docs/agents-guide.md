...
- Solutioning gate checks (Phase 34 transition)
- Course correction during implementation
...
- `solutioning-gate-check` - Validate Phase 34 transition
...
- Phase 34: solutioning-gate-check
...
| **Architect**           |    | 3 (Solutioning)    | architecture, gate-check                      | Technical design, architecture        |
...
| **Game Developer**      |    | 4 (Games)          | develop-story, story-done, code-review        | Game implementation                   |
| **Game Architect**      |    | 3 (Games)          | architecture, gate-check                      | Game systems architecture             |
