...
- No coupling between fixturesadd/remove freely
...
- Same logic runs everywherezero duplication
...
//
//   // No manual cleanup neededfixture handles it automatically
// });
```
...
- Tests don't manually clean uphappens automatically
...
- `AdminPage` inherits unnecessary `login` detailstight coupling
...
// Tests import exactly what they needno inheritance
```
