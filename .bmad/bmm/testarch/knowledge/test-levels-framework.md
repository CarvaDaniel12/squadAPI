...
- No UI involvedpure API validation
...
- Pure function testingno framework dependencies
...
| API contracts          |  Can't test |  Primary        |  Supplement |
| User journeys          |  Can't test |  Can't test     |  Primary    |
| Component props/events |  Partial    |  Component test |  Overkill   |
| Visual regression      |  Can't test |  Component test |  Primary    |
| Error handling (logic) |  Primary    |  Integration    |  Overkill   |
| Error handling (UI)    |  Partial    |  Component test |  Primary    |
