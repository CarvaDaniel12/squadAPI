...
**The Problem**: CI failures often provide minimal contexta timeout, a selector mismatch, or a network errorforcing developers to reproduce issues locally (if they can). This wastes time and discourages test maintenance.
